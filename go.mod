module v3-backend-transactions-go

go 1.25.3

require (
	github.com/0xsequence/ethkit v1.43.2
	github.com/0xsequence/go-sequence v0.64.2
)
...
require (
	...
	github.com/goware/cachestore v0.11.0 // indirect
